...
// Deal activities
    ...
    Route::get('deals/{deal}/proposals',
        [DealController::class, 'dealProposals']
    )->name('deal.get-proposals');

    Route::get('owner/{owner_id}/deals',
        [DealController::class, 'dealsByOwner']
    )->name('deals.owner');


Route::get('deal/details/{id}',
    [DealController::class, 'dealDetailsById']
)->name('deal.details');
