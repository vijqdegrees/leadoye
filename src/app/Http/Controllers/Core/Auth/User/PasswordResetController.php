...
class PasswordResetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['status' => true, 'message' => app_trans('default.hi_we_have_sent_an_email_containing_a_password_reset_link_to_your_email_address_please_check_it_and_confirm')]);
    }
