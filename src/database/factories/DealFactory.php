...
$factory->define(Deal::class, function (Faker $faker) {
    ...
    $common_description = 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s
    standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
    It has survived not only five centuries, but also the leap into electronic typesetting';
    $some_task_list_strings = "* [x] Done task sample ".PHP_EOL."* [ ] Another Task need to be done task sample.";
    $some_undone_task_list_strings= "* [ ] Need to be Done task sample.".PHP_EOL."* [ ] Another Task need to be done task sample.";
    $some_done_task_list_strings= "* [x] Done task sample.".PHP_EOL."* [x] Another done task sample.";
    $descriptions = [
        $common_description,
        $common_description.PHP_EOL.$some_task_list_strings,
        $common_description.PHP_EOL.$some_task_list_strings,
        $common_description.PHP_EOL.$some_undone_task_list_strings,
        $common_description.PHP_EOL. $some_done_task_list_strings,
    ];
